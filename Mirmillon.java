...
public class Mirmillon extends Gladiateur {
    ...
    public void recoitCoups(Gladiateur glad, Arme arme) {
        agresseur.add(glad);//se souvient du gladiateur qui l'a frappÈ
    ...
    public String saluer(){
        return "Ave Caesar, Mirmillon N∞"+ this.getIdg()+ " : " + this.getNom() + ", j'appartiens ‡† l'ethnie des " + this.getEthnie().getNom();
    }
